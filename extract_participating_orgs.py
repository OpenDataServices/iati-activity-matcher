...
def extract_participating_orgs():
    ...
    for i, activity in enumerate(registry.activities):
        ...
        for (
            ...
            participating_org_details_by_orgs[reporting_org][
                participating_org_ref
            ].append(
                {
        ...
        for participating_org_ref in participating_org_refs:
            ...
            participating_org_ref_dict_list = (
                participating_org_ref_dict_by_reporting_org[reporting_org]
            )
        ...
        if i != 0 and i % 100000 == 0:
            with open(
                "out/participating_org_ref_dict_by_reporting_org.json", "w"
            ) as fp:
...
@click.command()
def extract_participating_orgs_command():
    extract_participating_orgs()


if __name__ == "__main__":
    extract_participating_orgs_command()
